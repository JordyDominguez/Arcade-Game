...
var Engine = (function(global) {
    ...
    function updateEntities(dt) {
        allSharks.forEach(function(shark) {
            shark.update(dt);
        });
        crab.update(dt);
        player.update();
    ...
    function render() {
         ...
         */
        var rowImages = [
                'images/deep-water-block.png',   // Top row is water
                ...
                'images/sand-block.png',   // Row 1 of 2 of grass
     ...
     */
    Resources.load([
        'images/deep-water-block.png',
        'images/water-block.png',
        'images/enemy-shark.png',
        'images/boat.png',
